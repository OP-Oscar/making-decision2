...
// console.log(evensArr) //->simply checking if values are now present in evensARR
...
if (myFavoriteNumbers.length < 7){
  console.log(`Not enough elements, there are only ${myFavoriteNumbers.length }`)
}
else{
